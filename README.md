...
More information about the archiving project can be found on the ArchiveTeam wiki: [LINE BLOG](https://wiki.archiveteam.org/index.php?title=LINE BLOG)
...
We strongly encourage you to join the IRC channel associated with this project in order to be informed about project updates and other important announcements, as well as to be reachable in the event of an issue. The Archive Team Wiki has [more information about IRC](https://wiki.archiveteam.org/index.php/Archiveteam:IRC). We can be found at hackint IRC [#holdtheline](https://webirc.hackint.org/#irc://irc.hackint.org/#holdtheline).
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#holdtheline](https://webirc.hackint.org/#irc://irc.hackint.org/#holdtheline).
